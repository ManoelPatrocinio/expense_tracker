...
export const TableArea = ({ list }: Props) => {
  return (
    <C.Table>
      <thead>
        <tr>
          <C.TableHeadColumn width={24}>Data</C.TableHeadColumn>
          <C.TableHeadColumn width={24}>Categoria</C.TableHeadColumn>
          <C.TableHeadColumn width={24}>Título</C.TableHeadColumn>
          <C.TableHeadColumn width={24}>Valor</C.TableHeadColumn>
